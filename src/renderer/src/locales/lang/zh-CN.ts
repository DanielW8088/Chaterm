...
export default {
  ...
  personal: {
    ...
    accessKeySection: 'API 认证',
    accessKeyId: 'Access Key ID',
    accessKeyIdPlaceholder: '输入 Access Key ID',
    accessKeySecret: 'Access Key Secret',
    accessKeySecretPlaceholder: '输入 Access Key Secret',
    accessKeyTooltip: '可选。用于从 JumpServer REST API 获取资产节点分组。在 JumpServer 个人设置中创建 Access Key。',
    personal: '直接连接',
    enterprise: '堡垒机资源',
    editHost: '编辑主机',
    saveAsset: '保存',
