...
export default {
  ...
  personal: {
    ...
    accessKeySection: 'API Authentication',
    accessKeyId: 'Access Key ID',
    accessKeyIdPlaceholder: 'Enter Access Key ID',
    accessKeySecret: 'Access Key Secret',
    accessKeySecretPlaceholder: 'Enter Access Key Secret',
    accessKeyTooltip: 'Optional. Used to fetch asset node grouping from JumpServer REST API. Create an Access Key in JumpServer Personal Settings.',
    personal: 'Connect ',
